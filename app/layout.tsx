...
export const metadata: Metadata = {
  title: "Roger Paniagua · Creative Strategy Lead",
  description: "Design systems, brand strategy, and AI-driven development. Working with brands across LATAM and the U.S. from El Salvador.",
  icons: {
    icon: "/favicon.png",
    apple: "/favicon.png",
  },
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Roger Paniagua — El Salvador · LATAM · U.S.",
      },
    ],
    locale: "en_US",
    type: "website",
